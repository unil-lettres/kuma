...
Docker configuration for the [Uptime Kuma](https://github.com/louislam/uptime-kuma) application.
...
Use a reverse proxy configuration to map the url to port `8383`.

# Helm

The Helm charts for this project are available at [https://github.com/unil-lettres/k8s](https://github.com/unil-lettres/k8s), in the ``uplett`` directory.
